...
$meta_box_team = array(
	'id' => 'team_member',
    'title' => __('Team Member Details', 'golden'),
    'page' => 'team',
    'context' => 'normal',
    'priority' => 'high',
    'fields' => array(
        array(
        	'name' =>  __('Job Title', 'golden'),
            'desc' => __('Enter a job title for the Team Member <br />(ie; The Boss or Managing Director)', 'golden'),
            'id' => $prefix . 'member_title',
            'type' => 'text',
            'std' => ''
        ),
        array(
           'name' => __('Twitter', 'golden'),
