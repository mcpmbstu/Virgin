...
$meta_box_slider = array(
        ...
        'fields' => array(
            array(
                'name' => 'Slide Caption',
                'desc' => 'Add a short caption to appear on your slide.',
                'id' => $prefix . 'slide_caption',
                'type' => 'text',
                'std' => ''
            ),
            array(
                'name' => __('Slide URL', 'golden'),
                'desc' => __('Insert a url for the slide to link to.', 'golden'),
                'id' => $prefix . 'slide_url',
                'type' => 'text',
                'std' => ''
            ),
            array(
                ...
                'desc' => __('Add a title for your button <br />(ie; View our Work or Contact Us).', 'golden'),
                'id' => $prefix . 'slide_button_title',
                'type' => 'text',
                'std' => ''
            )
    )
