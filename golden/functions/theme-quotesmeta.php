...
$meta_box_quotes = array(
		'id' => 'quote_details',
        'title' => __('Quote Details', 'golden'),
        'page' => 'quotes',
        'context' => 'normal',
        'priority' => 'high',
        'fields' => array(
        	array(
        		'name' => __('Quote', 'golden'),
        	    'desc' => __('Enter a short quote or testimonial', 'golden'),
        	    'id' => $prefix . 'quotes_quote',
        	    'type' => 'text',
        	    'std' => ''
        	),
            array(
            	'name' => __('Author Name', 'golden'),
                'desc' => __('Enter the author name of the above quote <br />(ie; Orson Welles)', 'golden'),
