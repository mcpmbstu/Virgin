...
$meta_box_portfolio = array(
	...
	'title' =>  __('Portfolio Detail Settings', 'golden'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Portfolio Icon', 'golden'),
		    'desc' => __('Add an Icon for your portfolio item via Shortcode<br />(this will appear on your thumbnails)<br />Example: [icon name=icon-picture]<br /><br />A list of all available icons can be found <a href="http://fortawesome.github.com/Font-Awesome" target="_blank">here</a>', 'golden'),
		    'id' => $prefix . 'portfolio_icon',
		    'type' => 'text',
		    'std' => ''
		),
    	array(
			'name' =>  __('Portfolio Type', 'golden'),
			'desc' => __('Choose the type of portfolio you wish to display.', 'golden'),
		...
		array(
    	   'name' => __('Client Name', 'golden'),
    	   'desc' => __('Client who this project was completed for', 'golden'),
    	   'id' => $prefix . 'client_name',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Project Date', 'golden'),
    	   'desc' => __('What was the date of the completed project', 'golden'),
    	   'id' => $prefix . 'project_date',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Project Checklist', 'golden'),
    	   'desc' => __('Create a checklist of skills used on the project<br />(ie; Branding, Responsive Design, Strategy Planning etc...)', 'golden'),
    	   'id' => $prefix . 'project_checklist',
    	   'type' => 'textarea',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Project URL', 'golden'),
    	   'desc' => __('What is the URL for this project', 'golden'),
...
$meta_box_portfolio_portfolio_image = array(
	...
	'title' => __('Image Settings', 'golden'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
...
$meta_box_portfolio_portfolio_video = array(
	...
	'title' => __('Video Settings', 'golden'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Video Embed Code', 'golden'),
			'desc' => __('If you are using video from somewhere like YouTube, Vimeo etc... Please paste the embed code here. Width should be at least 960px with any height.<br><br>', 'golden'),
	...
	foreach ($meta_box_portfolio_portfolio_image['fields'] as $field) {
		...
		switch ($field['type']) {
			...
			?>
				...
				jQuery(function($) {
					...
					$('#gt_images_upload').on('click', function(e) {
						...
						var options = {
							title: '<?php _e("Create Featured Gallery", "golden"); ?>',
							state: 'gallery-edit',
							frame: 'post',
							selection: selection
						};
						...
						if( frame || selection ) {
							options['title'] = '<?php _e("Edit Featured Gallery", "golden"); ?>';
						}
						...
						frame.menu.get('view').get('gallery-edit').el.innerHTML = '<?php _e("Edit Featured Gallery", "golden"); ?>';
						...
						function overrideGalleryInsert() {
    						frame.toolbar.get('view').set({
								insert: {
									style: 'primary',
									text: '<?php _e("Save Featured Gallery", "golden"); ?>',
									...
									click: function() {
										...
										this.el.innerHTML = '<?php _e("Saving...", "golden"); ?>';
			...
			<?php
				...
				$thumbs_output = '';
				$button_text = ($meta) ? __('Edit Gallery', 'golden') : $field['std'];
				if( $meta ) {
					$field['std'] = __('Edit Gallery', 'golden');
					$thumbs = explode(',', $meta);
					$thumbs_output = '';
