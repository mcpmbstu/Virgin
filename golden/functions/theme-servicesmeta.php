...
$meta_box_service = array(
	'id' => 'service_details',
    'title' => __('Service Details', 'golden'),
    'page' => 'services',
    'context' => 'normal',
    'priority' => 'high',
    'fields' => array(
        array(
        	'name' => __('Service Icon', 'golden'),
            'desc' => __('Add an Icon for your service via Shortcode <br />Example: [icon name=icon-file]<br /><br />A list of all available icons can be found <a href="http://fortawesome.github.com/Font-Awesome" target="_blank">here</a>', 'golden'),
            'id' => $prefix . 'service_icon',
            'type' => 'text',
            'std' => ''
        ),
        array(
        	'name' =>  __('Service URL', 'golden'),
            'desc' => __('Add a URL for your button to link to <br />(ie; http://yoursite.com/web-development)', 'golden'),
            'id' => $prefix . 'service_url',
            'type' => 'text',
            'std' => ''
        ),
        array(
        	'name' =>  __('Button Title', 'golden'),
            'desc' => __('Add a title for your button <br />(ie; Discover More or Read More).', 'golden'),
            'id' => $prefix . 'service_button_title',
            'type' => 'text',
            'std' => ''
        )
    )
