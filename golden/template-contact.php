...
get_header(); ?>
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/jquery.realperson.css"> 
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/jquery.realperson.js"></script>
<script type="text/javascript">
/*	jQuery(function() {
	jQuery('#letters_code').realperson({
		length: 6,
		includeNumbers: true,
			...
			<section id="contact">
				...
				jQuery(document).ready(function($) {
					...
					<div class="row">
						...
						<?php echo do_shortcode('[contact-form-7 id="3130" title="Contact form 1"]'); ?>
						...
						<div class="eight columns omega">
							...
							<address id="contact-details">
							    ...
							    <?php } ?>
                                <li><a href="http://virginiasvintagehirescotland.co.uk/"><img src="<?php echo get_template_directory_uri(); ?>/images/scottish.jpg" alt="" /></a></li>
...
<?php get_footer(); ?>
<?php $mandrill = Mandrill('QLxOhezZVMcoyZRXJoz55g'); echo $mandrill->ping(); ?>