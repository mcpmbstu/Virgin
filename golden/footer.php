...
jQuery( document ).ready(function() {
    ...
    jQuery(function(){
        jQuery("body.page-id-2881 #content a").attr("target","_blank");
    });
	...
	jQuery(".filter_new .special-class a").click(function () {
		jQuery.removeCookie('the_cookie');
        //addressValue = jQuery(this).attr("href");
		//jQuery.removeCookie('the_cookie');
    ...
    var str = jQuery(".container>#content>.sixteen>h1").text();
    var result = str.bold();
    
    jQuery(".container>#content>.sixteen>h1").html(result);
    //alert(result);
